...
info "  adb install-multiple ${OUTPUT_DIR}/base.apk ${OUTPUT_DIR}/split_config.arm64_v8a.apk ${OUTPUT_DIR}/split_config.<lang>.apk ${OUTPUT_DIR}/split_config.xhdpi.apk"
